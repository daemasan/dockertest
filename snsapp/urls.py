...
urlpatterns = [
    ...
    #test練習
    path('test',top,name='top'),
    path('test/snippets/new/', views.snippet_new, name='snipet_new'),
    path('test/snippets/<int:snippet_id>/',views.snippet_detail, name='snippet_detail'),
    path('test/snippets/<int:snippet_id>/edit/', views.snippet_edit, name="snippet_edit"),
